...
# Łączymy dziecko AnimatedSprite2D ze zmienną _animated_sprite_2d
...
func animate() -> void:
	if direction:
		...
		# else:
		# 	var1 = 2"
		# Możemy uprościć do jednej lini:
		# "var1 = 1 if twierdzenie else 2"
		# Ponieważ flip_h jest boolionem, a "direction > 0" zwraca boolion,
		# możemy tą linijkę uprościć dalej:
